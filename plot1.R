...
# draw the histogram as required setting the labels and colors
hist(as.numeric(pcd_subset$Global_active_power),main = "Global Active Power",col = "red", xlab = "Global Active Power(kilowatts)", ylab = "Frequency")
